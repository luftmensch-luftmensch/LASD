...
void MapPreOrder(lasd::BinaryTree<Data>& binarytree, typename lasd::MappableContainer<Data>::MapFunctor fun, const Parameter& inipar) {
  Parameter par = {inipar};
  try {
    binarytree.MapPreOrder(fun, &par);
  }
...
template <typename Data, typename Parameter>
void MapPostOrder(lasd::BinaryTree<Data>& binarytree, typename lasd::MappableContainer<Data>::MapFunctor fun, const Parameter& inipar) {
  Parameter par = {inipar};
  try {
    binarytree.MapPostOrder(fun, &par);
  }
  catch(std::exception exc) {
    std::cout << exc.what()<< std::endl;
  }
...
template <typename Data, typename Parameter>
void MapInOrder(lasd::BinaryTree<Data>& binarytree, typename lasd::MappableContainer<Data>::MapFunctor fun, const Parameter& inipar) {
  Parameter par = {inipar};
  try {
    binarytree.MapInOrder(fun, &par);
  }
  catch(std::exception exc) {
    std::cout << exc.what()<< std::endl;
  }
...
template <typename Data, typename Parameter>
void MapBreadth(lasd::BinaryTree<Data>& binarytree, typename lasd::MappableContainer<Data>::MapFunctor fun, const Parameter& inipar) {
  Parameter par = {inipar};
  try {
    binarytree.MapBreadth(fun, &par);
  }
  catch(std::exception exc) {
    std::cout << exc.what()<< std::endl;
  }
...
template <typename Data>
bool MapMatch(const Data& dat, void* elem) {
  bool boolean=false;
  //static_cast<Data>(elem);
  if(dat==elem){
     boolean=true;
  }
  return boolean;
