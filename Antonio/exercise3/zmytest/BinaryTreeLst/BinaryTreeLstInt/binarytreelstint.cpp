...
void OperazioniBinaryTreeLstInt(lasd::BinaryTreeLnk<Data>& btlst, unsigned long N){
char scelta;
Data elem;
...
switch(scelta){
    case '1':
      ...
      MapPreOrder(btlst,&MapPrint<int>, 0);
      OperazioniBinaryTreeLstInt(btlst,N);
      break;
    case '2':
      std::cout << "\033[2J\033[1;1H";
      cout<<"Visualizzazione in PostOrder: \n\n\n"<<endl;
      MapPostOrder(btlst,&MapPrint<int>, 0);
      OperazioniBinaryTreeLstInt(btlst,N);
      break;
    case '3':
      std::cout << "\033[2J\033[1;1H";
      cout<<"Visualizzazione in InOrder: \n\n\n"<<endl;
      MapInOrder(btlst,&MapPrint<int>, 0);
      OperazioniBinaryTreeLstInt(btlst,N);
      break;
    case '4':
      std::cout << "\033[2J\033[1;1H";
      cout<<"Visualizzazione in Ampiezza: \n\n\n"<<endl;
      MapBreadth(btlst,&MapPrint<int>,0);
      OperazioniBinaryTreeLstInt(btlst,N);
      break;
    case '5':
      std::cout << "\033[2J\033[1;1H";
    ...
    case '7':
      ...
      case '8': {
        ...
        lasd::BTBreadthIterator<Data> itr(btlst);
    ...
    case '9': {
        ...
        lasd::BinaryTree<int>* btlst1=&btlst;
        bool boolean=true;
        typename lasd::BinaryTree<Data>::Node* current = &btlst1->Root();
    ...
    case 'A':{
       ...
       lasd::BTPreOrderIterator<Data> itr(btlst);
       int i=0;
       char q;
       while(i<N){
   ...
   case 'B':{
      ...
      lasd::BTPostOrderIterator<Data> itr(btlst);
      int i=0;
      char q;
      while(i<N){
        cout<<"\nL'elemento corrente e' : "<<*itr<<endl;
  ...
  case 'C':{
     ...
     lasd::BTInOrderIterator<Data> itr(btlst);
     int i=0;
     char q;
     while(i<N){
       cout<<"\nL'elemento corrente e' : "<<*itr<<endl;
 ...
 case 'D':{
  ...
  case 'E':{
    lasd::BTBreadthIterator<int> itr(btlst);
  ...
  case 'F':{
    ...
    cout<<"\n\n"<<endl;
    MapPreOrder(btlst,&MapPrint<int>,0);
    MapPreOrder(btlst,&MapTriple<int>,0);
    cout<<"\n\n"<<endl;
    MapPreOrder(btlst,&MapPrint<int>,0);
...
void BinaryTreeLstInt(){
  ...
  lasd::BinaryTreeLnk<int> btlst(vector);
