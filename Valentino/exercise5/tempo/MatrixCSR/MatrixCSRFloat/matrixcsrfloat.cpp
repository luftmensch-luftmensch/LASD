...
void OperazioniMatrixCSRFloat(lasd::MatrixCSR<Data>& matrix){
char scelta;
Data elem;
...
switch(scelta){
    case '1':
      ...
      OperazioniMatrixCSRFloat(matrix);
      break;
    case '2':
      std::cout << "\033[2J\033[1;1H";
...
void MatrixCSRFloat(){
  ...
  lasd::MatrixCSR<float> matrix(rows,columns);
  std::cout<<"\n"<<std::endl;
